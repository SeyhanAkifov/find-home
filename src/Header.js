		...
		<div className="container-fluid p0">
             <nav>
                ...
                <ul id="respMenu" className="ace-responsive-menu text-right" data-menu-style="horizontal">
	                ...
	                <li className="list-inline-item add_listing"><a href="page-add-new-property.html"><span className="flaticon-plus"></span><span className="dn-lg"> Create Listing</span></a></li>
		        </ul>
		    </nav>
		</div>
	</header>
